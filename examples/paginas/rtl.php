...
<body class="rtl sidebar-mini rtl-active">
            ...
            <ul class="nav">
              ...
              <li >
                <a href="iniciarsesion.php">
                  <span class="sidebar-mini-icon">هعذا</span>
              ...
              <li >
                <a href="registro.php">
                  <span class="sidebar-mini-icon">صع</span>
                ...
                <table class="table">
                  <tbody>
                    <tr>
                      ...
                      <td class="img-row">
                        <div class="img-wrapper img-raised">
                          <img src="inc/adm/assets/img/emilyz.jpg" class="img-raised">
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td class="img-row">
                        <div class="img-wrapper img-raised">
                          <img src="inc/adm/assets/img/james.jpg" class="img-raised">
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td class="img-row">
                        <div class="img-wrapper img-raised">
                          <img src="inc/adm/assets/img/mike.jpg" class="img-raised">
                        </div>
                      </td>
        ...
        <div class="col-md-6">
          <div class="card card-testimonial">
            ...
            <div class="card-header card-header-avatar">
              <a href="#pablo">
                <img class="img img-raised" src="inc/adm/assets/img/james.jpg">
              </a>
            </div>
  ...
  <!-- Pie de pagina -->
  <?php
  require_once(RUTA_SISTEMA . "inc/ooter.php");
  ?>
  </div>
...
<!-- Libreias js -->
<?php
require_once(RUTA_SISTEMA . "inc/cript.php");
?>
