        ...
        <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
          <div class="container-fluid">
            <div class="navbar-wrapper">
              ...
              <a class="navbar-brand" href="#pablo">Tablas Regulares</a>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-plain">
              <div class="card-header">
                <h4 class="card-title"> Tabla sobre fondo liso</h4>

                <p class="category"> Aquí Hay Un Subtítulo Para Esta Tabla.</p>
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Mesa regular con colores</h4>
