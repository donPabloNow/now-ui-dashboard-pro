    ...
    initDashboardPageCharts: function(){
      ...
      showSwal: function(type){
        if(type == 'basic'){
          ...
          Swal.fire({
            title: 'Are you sure?',
            text: "Este es el que me esta dando problemas 1!",
            type: 'warning',
            showCancelButton: true,
            confirmButtonClass: 'btn btn-success',
            cancelButtonClass: 'btn btn-danger',
          ...
          swalWithBootstrapButtons.fire({
            title: 'Estás seguro?',
            text: "Este es el que me esta dando problemas 2!",
            type: 'warning',
            showCancelButton: true,
            confirmButtonText: 'Yes, delete it!',
    ...
    initGoogleMaps: function(){
      ...
      initSmallGoogleMaps: function(){
        ...
        showNotification: function(from, align){
          ...
          message: "Bienvenido a <b>Now Ui Dashboard Pro</b> -  un hermoso regalo para cada desarrollador web."
        },{
          type: color,
          timer: 4000,
          placement: {
