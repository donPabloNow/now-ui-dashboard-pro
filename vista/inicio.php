     ...
     <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navigation">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a href="../examples/tablero/dashboard.php" class="nav-link">
                <i class="now-ui-icons design_app"></i>
                Tablero
              </a>
            </li>
            <li class= "nav-item ">
              <a href="../examples/paginas/registro.php" class="nav-link">
            ...
            <li class= "nav-item ">
              <a href="../examples/paginas/pricing.php" class="nav-link">
            ...
            <li class= "nav-item ">
              <a href="../examples/paginas/Bloquear.php" class="nav-link">
                <i class="now-ui-icons ui-1_lock-circle-open"></i>
                Bloquear
              </a>
            </li>
            <li class= "nav-item ">
              <a href="../examples/paginas/factura.php" class="nav-link">
